...
namespace KRPC.MechJeb.ExtensionMethods {
	internal static class VesselExtensions {
		...
		/// <summary>
		/// Invokes MechJeb's <c>GetMasterMechJeb</c> operation.
		/// </summary>
		...
		/// <summary>
		/// Invokes MechJeb's <c>PlaceManeuverNode</c> operation.
		/// </summary>
		...
		/// <summary>
		/// Invokes MechJeb's <c>RemoveAllManeuverNodes</c> operation.
		/// </summary>
