...
namespace KRPC.MechJeb {
	...
	public class SmartASS : DisplayModule {
		...
		/// <summary>
		/// Specifies values for <c>SmartASSInterfaceMode</c>.
		/// </summary>
		...
		/// <summary>
		/// Specifies values for <c>SmartASSAutopilotMode</c>.
		/// </summary>
		[KRPCEnum(Service = "MechJeb")]
		...
		/// <summary>
		/// Specifies values for <c>AttitudeReference</c>.
		/// </summary>
		[KRPCEnum(Service = "MechJeb")]
		public enum AttitudeReference {
			...
			/// <summary>
			/// forward = toward relative velocity direction, up = MechJeb's reference up vector
			/// </summary>
			RelativeVelocity,
			...
			/// <summary>
			/// forward = next maneuver node direction, up = MechJeb's reference up vector
			/// </summary>
			ManeuverNode,
