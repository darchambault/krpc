...
namespace KRPC.MechJeb {
	/// <summary>
	/// Provides access to MechJeb's <c>TargetController</c> functionality.
	/// </summary>
	...
	public class TargetController : ComputerModule {
		...
		/// <summary>
		/// Invokes MechJeb's <c>SetPositionTarget</c> operation.
		/// </summary>
		[KRPCMethod]
		...
		/// <summary>
		/// Invokes MechJeb's <c>GetPositionTargetString</c> operation.
		/// </summary>
		[KRPCMethod]
		...
		/// <summary>
		/// Invokes MechJeb's <c>GetPositionTargetPosition</c> operation.
		/// </summary>
		[KRPCMethod]
		...
		/// <summary>
		/// Invokes MechJeb's <c>SetDirectionTarget</c> operation.
		/// </summary>
		[KRPCMethod]
		...
		/// <summary>
		/// Invokes MechJeb's <c>PickPositionTargetOnMap</c> operation.
		/// </summary>
		[KRPCMethod]
		...
		/// <summary>
		/// Invokes MechJeb's <c>UpdateDirectionTarget</c> operation.
		/// </summary>
		[KRPCMethod]
		...
		/// <summary>
		/// Whether a normal vessel or celestial-body target is selected.
		/// </summary>
		[KRPCProperty]
		public bool NormalTargetExists => (bool)normalTargetExists.GetValue(this.instance, null);

		/// <summary>
		/// Whether a surface position target is selected.
		/// </summary>
		[KRPCProperty]
		public bool PositionTargetExists => (bool)positionTargetExists.GetValue(this.instance, null);

		/// <summary>
		/// Whether MechJeb can align the active vessel with the current target.
		/// </summary>
		[KRPCProperty]
