...
namespace KRPC.MechJeb.Maneuver {
	/// <summary>
	/// Specifies values for <c>TimeReference</c>.
	/// </summary>
	...
	/// <summary>
	/// Provides access to MechJeb's <c>TimeSelector</c> functionality.
	/// </summary>
	...
	public class TimeSelector {
		...
		/// <summary>
		/// Gets or sets the value of <c>TimeReference</c> in MechJeb.
		/// </summary>
		[KRPCProperty]
