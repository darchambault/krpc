...
namespace KRPC.MechJeb {
	/// <summary>
	/// Provides access to MechJeb's <c>ThrustController</c> functionality.
	/// </summary>
	...
	public class ThrustController : ComputerModule {
		...
		/// <summary>
		/// Gets or sets the value of <c>LimitDynamicPressure</c> in MechJeb.
		/// </summary>
		[KRPCProperty]
		...
		/// <summary>
		/// Gets or sets the value of <c>LimitAcceleration</c> in MechJeb.
		/// </summary>
		[KRPCProperty]
		...
		/// <summary>
		/// Gets or sets the value of <c>LimitThrottle</c> in MechJeb.
		/// </summary>
		[KRPCProperty]
		...
		/// <summary>
		/// Gets or sets the value of <c>LimiterMinThrottle</c> in MechJeb.
		/// </summary>
		[KRPCProperty]
		...
		/// <summary>
		/// Gets or sets the value of <c>SmoothThrottle</c> in MechJeb.
		/// </summary>
		[KRPCProperty]
		...
		/// <summary>
		/// Gets or sets the value of <c>ThrottleSmoothingTime</c> in MechJeb.
		/// </summary>
		[KRPCProperty]
		...
		/// <summary>
		/// Gets or sets the value of <c>LimitToPreventFlameout</c> in MechJeb.
		/// </summary>
		[KRPCProperty]
		...
		/// <summary>
		/// Gets or sets the value of <c>ManageIntakes</c> in MechJeb.
		/// </summary>
		[KRPCProperty]
		...
		/// <summary>
		/// Gets or sets the value of <c>DifferentialThrottle</c> in MechJeb.
		/// </summary>
		[KRPCProperty]
		...
		/// <summary>
		/// The result of MechJeb's most recent differential-throttle calculation.
		/// </summary>
		[KRPCProperty]
		...
		/// <summary>
		/// Gets or sets the value of <c>ElectricThrottle</c> in MechJeb.
		/// </summary>
		[KRPCProperty]
	...
	/// <summary>
	/// Specifies values for <c>DifferentialThrottleStatus</c>.
	/// </summary>
	...
	public enum DifferentialThrottleStatus {
		...
		Success,
		/// <summary>
		/// Selects <c>AllEnginesOff</c>.
		/// </summary>
		AllEnginesOff,
		/// <summary>
		/// Selects <c>MoreEnginesRequired</c>.
		/// </summary>
		MoreEnginesRequired,
		/// <summary>
		/// Selects <c>SolverFailed</c>.
		/// </summary>
		SolverFailed
	}
}
