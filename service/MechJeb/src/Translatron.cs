...
namespace KRPC.MechJeb {
	...
	public class Translatron : DisplayModule {
		...
		/// <summary>
		/// Speed that the Translatron will hold.
		/// </summary>
		[KRPCProperty]
		...
		/// <summary>
		/// Abort the mission by separating all but the last stage and activating the landing autopilot.
		/// </summary>
		[KRPCMethod]
		...
		/// <summary>
		/// Specifies values for <c>TranslatronMode</c>.
		/// </summary>
