.. _tutorials/mechjeb-docking:
.. currentmodule:: MechJeb

Docking with a Target
=====================

This script will dock any rocket with a targeted rocket. The script assumes the target is a ship and it is next to the target.

The complete program is available in a variety of languages:

:download:`Java</scripts/tutorials/mechjeb/docking/DockingWithTarget.java>`,
:download:`Python</scripts/tutorials/mechjeb/docking/DockingWithTarget.py>`
...
.. tabs::
  ...
  .. group-tab:: Java
    ...
    .. literalinclude:: /scripts/tutorials/mechjeb/docking/DockingWithTarget.java
      :language: java
      :lines: 15-21
      :lineno-start: 15
      :linenos:
  ...
  .. group-tab:: Python
    ...
    .. literalinclude:: /scripts/tutorials/mechjeb/docking/DockingWithTarget.py
      :language: python
      :lines: 1-7
      :linenos:
