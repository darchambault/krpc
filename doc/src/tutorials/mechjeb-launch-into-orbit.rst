.. _tutorials/mechjeb-launch-into-orbit:
...
:download:`Java</scripts/tutorials/mechjeb/launch-into-orbit/LaunchIntoOrbit.java>`,
:download:`Python</scripts/tutorials/mechjeb/launch-into-orbit/LaunchIntoOrbit.py>`
...
.. tabs::
  ...
  .. group-tab:: Java
    ...
    .. literalinclude:: /scripts/tutorials/mechjeb/launch-into-orbit/LaunchIntoOrbit.java
      :language: java
      :lines: 12-27
      :lineno-start: 12
      :linenos:
  ...
  .. group-tab:: Python
    ...
    .. literalinclude:: /scripts/tutorials/mechjeb/launch-into-orbit/LaunchIntoOrbit.py
      :language: python
      :lines: 1-17
      :linenos:
